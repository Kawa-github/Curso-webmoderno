(function ($) {
    $.fn.temporizador = function (opcoes) {
        const opcoesFinais = $.extend({
            mensagem: 'Em breve!', //valor padrão, caso n passe nenhuma mensagem
            horario: '23:59:59'
        }, opcoes)
        ...
        const horarioAlvo = regex.exec(opcoesFinais.horario) //pegando o horário
        // console.log(horarioAlvo)

        let temporizador = setInterval(() => {
            const agora = new Date() // hora atual
            const alvo = new Date() // horário alvo. [1] Hora [2] Minutos [3] Segundos
